...
void new_source_file()
{
  ...
  GtkSourceCompletion *sc1 = gtk_source_view_get_completion((GtkSourceView *)view);
...
void fb_load_source_file()
{
  ...
  dialog = gtk_file_chooser_dialog_new ("Open Smalltalk source file",
                                        (GtkWindow *)file_browser_window,
...
void save_file()
{
  ...
  if(strlen(current_file_name) == 0)
  {
    ...
    dialog = gtk_file_chooser_dialog_new ("Save Smalltalk source file",
                                          (GtkWindow *)file_browser_window,
...
GtkToolbar *create_file_browser_toolbar()
{
  ...
  GtkWidget *new_icon     = gtk_image_new_from_file (SMALLTALKDATADIR "/icons/new_file.png");
  GtkWidget *open_icon    = gtk_image_new_from_file (SMALLTALKDATADIR "/icons/open_file.png");
  GtkWidget *save_icon    = gtk_image_new_from_file (SMALLTALKDATADIR "/icons/save_file.png");
  GtkWidget *close_icon   = gtk_image_new_from_file (SMALLTALKDATADIR "/icons/close_file.png");
  GtkWidget *refresh_icon = gtk_image_new_from_file (SMALLTALKDATADIR "/icons/refresh.png");
  GtkWidget *find_icon    = gtk_image_new_from_file (SMALLTALKDATADIR "/icons/find.png");
