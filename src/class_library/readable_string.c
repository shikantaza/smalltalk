...
void create_ReadableString()
{
  ...
  cls_obj->instance_methods->bindings[11]->val = create_method(convert_class_object_to_object_ptr(cls_obj), false,
  ...
  cls_obj->instance_methods->bindings[12]->val = create_method(convert_class_object_to_object_ptr(cls_obj), false,
  ...
  cls_obj->instance_methods->bindings[13]->val = create_method(convert_class_object_to_object_ptr(cls_obj), false,
